  ...
  return (
    <header className="sticky top-0 z-50 w-full mx-auto bg-white/75 backdrop-blur-lg dark:bg-zinc-900/90">
      <div className="flex items-center justify-between px-4 py-3">
        ...
        >
          <span
            className={`block w-6 h-0.5 bg-black dark:bg-white transition-transform duration-300 ease-in-out ${isMenuOpen ? 'rotate-45 translate-y-2' : ''
              }`}
          />
          <span
            className={`block w-6 h-0.5 bg-black dark:bg-white transition-opacity duration-300 ease-in-out ${isMenuOpen ? 'opacity-0' : 'opacity-100'
              }`}
          />
          <span
            className={`block w-6 h-0.5 bg-black dark:bg-white transition-transform duration-300 ease-in-out ${isMenuOpen ? '-rotate-45 -translate-y-2' : ''
      ...
      {isMenuVisible && (
        <MobileMenuPortal>
          <div
            className={`fixed inset-0 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-sm z-[1000] ${isMenuOpen ? 'animate-slide-in' : 'animate-slide-out'
