  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-6 text-center text-white overflow-hidden">
      <div className="z-10 w-full flex flex-col items-center justify-center">
        ...
        {/* Hero Text */}
        <h1 className="text-4xl font-bold tracking-wide text-center text-black dark:text-white">Welcome to CSA</h1>
        <h2 className="text-3xl font-bold text-center py-10 text-black dark:text-white">About Us</h2>
